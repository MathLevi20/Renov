            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                {loading ? (
                  ...
                  <button
                    className="w-full px-4 py-3 hover:bg-lime-400 font-bold text-slate-800 bg-[#63FF8D] rounded-md border-2  border-[#63FF8D]  focus:outline-none focus:shadow-outline-indigo focus:border-[#63FF8D]"

      ...
      <div className="grid grid-cols-2 ">
        <div className=" bg-white h-fit w-fit shadow-lg p-10 m-10 mx-20 rounded-md">
          ...
          <div className="mb-4 grid grid-rows-2">
            ...
            <div>
              ...
              <button
                className={`mr-2 px-4 py-2 border ${
                  selectedStatus === "completo" ? "bg-blue-500 text-white" : ""
                }`}
              ...
              <button
                className={`mr-2 px-4 py-2 border ${
                  selectedStatus === "anunciado" ? "bg-blue-500 text-white" : ""
                }`}
        ...
        <div className="my-auto h-full">
          {filteredItems.map((item: any) => (
            <div
              className="max-w-sm rounded overflow-hidden p-10 shadow-md"
              key={item.id}
            >
              <div>
                <p>Tipo: {item.type} </p>

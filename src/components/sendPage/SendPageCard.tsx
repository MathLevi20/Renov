...
const ResidueCard: React.FC<ResidueCardProps> = ({
  ...
  return (
      ...
      {accepted === true && <p className="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none">Estado: Aceito</p>}
      {accepted === false && <p className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none">Estado: falso</p>}
      {accepted === null && <p className="px-4 py-2 bg-slate-500 text-white rounded-md hover:bg-green-600 focus:outline-none">Estado: Espera</p>}
